 ...
 */
package retrofit.adapter.kotlin.experimental;
...
import retrofit.adapter.coroutines.experimental.KotlinCoroutineCallAdapterFactory;
...
public final class KotlinCoroutineCallAdapterFactoryTest {
  private static final Annotation[] NO_ANNOTATIONS = new Annotation[0];

  @Rule public final MockWebServer server = new MockWebServer();

  private final CallAdapter.Factory factory = new KotlinCoroutineCallAdapterFactory();
  ...
  @Test public void rawTypeThrows() {
    ...
    try {
      ...
      assertThat(e).hasMessage(
          "Deferred return type must be parameterized as Deferred<Foo> or Deferred<? extends Foo>");
    }
  }
